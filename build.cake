...
Task("Package")
    ...
    {
        var package =
            outputPackages + File("Nancy.Bootstrappers.StructureMap-Latest.zip");
    ...
    .Does(() =>
    {
        ...
        else
        {
            ...
            var settings = new ProcessSettings {
                Arguments = xunit + " " + "test/Nancy.Bootstrappers.StructureMap.Tests/bin/"+configuration+"/net452/unix-x64/Nancy.Bootstrappers.StructureMap.Tests.dll"
            };
            ...
            using(var process = StartAndReturnProcess("mono", settings))
            {
                ...
                {
                    throw new Exception("Nancy.Bootstrappers.StructureMap.Tests failed.");
                }
            }
        }
    });
...
Task("Update-Version")
    ...
    .Does(() =>
    {
        ...
        UpdateProjectJsonVersion(version, "src/Nancy.Bootstrappers.StructureMap/project.json");
    });
